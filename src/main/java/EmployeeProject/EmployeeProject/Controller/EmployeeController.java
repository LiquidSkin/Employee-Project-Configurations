package EmployeeProject.EmployeeProject.Controller;

import EmployeeProject.EmployeeProject.Exception.ApiRequestException;
import EmployeeProject.EmployeeProject.Model.Department;
import EmployeeProject.EmployeeProject.Model.Employee;
import EmployeeProject.EmployeeProject.Repository.DepartmentRepository;
import EmployeeProject.EmployeeProject.Repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    List<Employee> getAllEmployees() {
              throw new ApiRequestException("Cannot find all the students");
